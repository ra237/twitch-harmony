...
## Usage
In order to use this extension it is <ins>**crucial**</ins> to create a `.env` file in the root directory of your Harmony bot. Within that file you need to include your [*client id*](https://github.com/ra237/twitch-harmony/wiki/Client-ID) and *auth token* you got from Twitch:
```  
TWITCH_CLIENT_ID=
TWITCH_AUTH_TOKEN=
``` 
